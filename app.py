...
@app.route('/Uploads_Examples/Aspirin')
def getAspirin():
    return send_file(os.path.join(path,'files2Read/templates/Aspirin.sdf'),  attachment_filename="Aspirin.sdf", as_attachment=True)


@app.route('/Uploads_Examples/Molecules')
def getMolecules():
    return send_file(os.path.join(path,'files2Read/templates/molecules.zip'), attachment_filename="molecules.zip", as_attachment=True)
